    ...
    <footer className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0f172a] to-slate-800/50">
      <div className="container mx-auto max-w-4xl text-center">
        <div className="mb-8 animate-fade-in-up">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-brand-green/10 mb-6 animate-bounce">
          ...
          <button
            onClick={onStart}
            className="bg-brand-green hover:bg-brand-green/90 text-white shadow-lg text-lg px-8 py-6 rounded-full transition-all duration-300 hover:scale-105"
          >
            Enter App Interface
          </button>
        </div>
